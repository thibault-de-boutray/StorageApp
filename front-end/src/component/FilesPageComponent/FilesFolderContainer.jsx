...
export const FilesFolderContainer = ({ numbers, size, maxSize, selectedLabel, onSelectLabel }) => {
        ...
        return numbers.map((_, index) => {
            return (
                <FilesFolderRow
                    key={labels[index]}
                    label={labels[index]}
                    isActive={selectedLabel === labels[index]}
                    onClick={() => onSelectLabel?.(labels[index])}
                />
            )
        });
    };
