...
export const FilesStorageContainer = ({ size, maxSize }) => {
    ...
    return (
        <div className="file-storage-section px-2 pb-5">
            <p className="text-sm text-gray-300">Storage</p>
            <div className="flex items-center gap-2 py-2 text-xs text-gray-200">
            ...
            <button type="button" className="button-secondary w-full mt-3 text-sm py-2">
                Upgrade Storage
            </button>
        </div>
    )
